...
use App\Filament\Resources\MasterEmployeePermissionResource\Pages;
use App\Filament\Resources\MasterEmployeePermissionResource\RelationManagers;
...
class MasterEmployeePermissionResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('Form Jenis Cuti')
                    ->description('Input jenis Cuti pada form di bawah ini.')
                    ->schema([
