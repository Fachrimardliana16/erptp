...
<body>
    ...
    <h4 align="center">Laporan Daftar Monitoring Aset</h4>
        ...
        <tbody>
            @foreach($records as $record)
                <tr>
                    ...
                    <td>{{ $record->monitoring_date }}</td>
                    <td>{{ $record->assetMonitoring->assets_number }}</td>
                    <td>{{ $record->assetMonitoring->name }}</td>
                    <td>{{ $record->MonitoringoldCondition->name }}</td>
                    <td>{{ $record->MonitoringNewCondition->name }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
