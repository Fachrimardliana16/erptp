...
<body>
    ...
    <h4 align="center">Laporan Daftar Perpanjangan Dokumen</h4>
    <table cellpadding="5" cellspacing="0">
        <thead>
            <tr>
                ...
                <th>Lokasi</th>
                <th>Biaya</th>
                <th>Perpanjangan Selanjutnya</th>
            </tr>
        </thead>
        <tbody>
            @foreach($records as $record)
                <tr>
                    ...
                    <td>{{ $record->AssetDocumentExtension->name }}</td>
                    <td>{{ $record->document_type }}</td>
                    <td>{{ $record->location }}</td>
                    <td>Rp {{ number_format($record->cost, 0, ',','.') }}</td>
                    <td>{{ $record->next_expiry_date }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
