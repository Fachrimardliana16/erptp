...
<body>
    ...
    <h4 align="center">Laporan Mutasi Aset</h4>
        ...
        <tbody>
            @foreach($records as $record)
                <tr>
                    ...
                    <td>{{ $record->mutation_date }}</td>
                    <td>{{ $record->AssetsMutation->assets_number }}</td>
                    <td>{{ $record->AssetsMutation->name }}</td>
                    <td>{{ $record->MutationCondition->name}}</td>
                    <td>{{ $record->AssetsMutationLocation->name}}</td>
                    <td>{{ $record->AssetsMutationsubLocation->name }}</td>
                    <td>{{ $record->AssetsMutationemployee->name }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
