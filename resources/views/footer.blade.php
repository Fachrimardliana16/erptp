<footer
    ...
    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024
        <a href="https://pdampurbalingga.co.id" class="hover:underline">Tirta Perwira Kab. Purbalingga</a>. All Rights
        Reserved. | Departement Information Technology Tirta Perwira
    </span>
</footer>
