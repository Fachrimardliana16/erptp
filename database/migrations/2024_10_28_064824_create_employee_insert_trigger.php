    ...
    public function up()
    {
        ...
        DB::unprepared('
            ...
            BEGIN
                ...
                -- Get related data from master_employee_basic_salary
                SELECT 
                    employee_grade_id,
                    amount
                INTO 
                ...
                INSERT INTO employees (
                    id, nippam, name, place_birth, date_birth, gender, religion, age, address, phone_number, email, retirement,
                    master_employee_agreement_id, agreement_date_start, agreement_date_end, employee_education_id, 
                    basic_salary_id, employee_grade_id, grade_date_start, grade_date_end, basic_salary, 
                    periodic_salary_date_start, periodic_salary_date_end, employee_position_id, departments_id, 
                    sub_department_id, users_id, employment_status_id, created_at, updated_at
                ) VALUES (
                    v_uuid, v_nippam, NEW.name, v_place_of_birth, v_date_of_birth, v_gender, v_religion, v_age, v_address, 
                    v_contact, v_email, v_retirement_date, NEW.agreement_id, NEW.agreement_date_start, 
                    NEW.agreement_date_end, v_employee_education_id, NEW.basic_salary_id, v_employee_grade_id, 
                    NEW.agreement_date_start, v_grade_date_end, v_basic_salary, NEW.agreement_date_start, v_periodic_salary_date_end, 
