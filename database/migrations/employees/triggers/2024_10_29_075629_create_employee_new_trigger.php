...
class CreateEmployeeNewTrigger extends Migration
{
    public function up()
    {
        ...
        BEGIN
            ...
            DECLARE v_basic_salary_id CHAR(36); -- Menambahkan variabel untuk basic_salary_id
            DECLARE v_employee_service_grade_id CHAR(36);
            ...
            SELECT 
                ...
                employee_grade_id,
                id,  -- This should come before amount
                amount  -- This is the basic salary amount
            INTO 
                v_employee_service_grade_id,
                v_employee_grade_id,
                v_basic_salary_id,
                v_basic_salary
            ...
            INSERT INTO employees (
                ...
                basic_salary_id, employee_service_grade_id
            ) VALUES (
                ...
                v_basic_salary_id, v_employee_service_grade_id
            );
        END
    ');
